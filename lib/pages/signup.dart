...
class _SignUpState extends State<SignUp> {
  ...
  //       await SharedPreferencesHelper().saveUserDisplayName( emailController.text.replaceAll("@gmail.com", ""));
  ...
  //       await SharedPreferencesHelper().saveUserPic("https://firebasestorage.googleapis.com/v0/b/barberapp-ebcc1.appspot.com/o/icon1.png?alt=media&token=0fad24a5-a01b-4d67-b4a0-676fbc75b34a");
